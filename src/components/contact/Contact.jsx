...
const addressData = [
  {
    icon: faLocationDot,
    title: "Address",
    description: "Ramnagar-244715, Uttrakhand",
  },
  {
    icon: faEnvelope,
    title: "My Email",
    description: "kumar.lalit.tsx@gmail.com",
  },
  {
    icon: faPhone,
    title: "Call Me Now",
    description: "+91-7900678792",
  },
];
          ...
          <div>
            <div>
              ...
              <p className="text-[12px] xs:text-[14px] sm:text-lg md:text-lg max-lg:text-center pt-4 font-normal text-soft-dark">
                I'm open to internship and job opportunities. Feel free to reach out for collaboration or hiring.
              </p>
            </div>
